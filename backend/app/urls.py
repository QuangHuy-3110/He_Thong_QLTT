...
from .views import (
    ...
    AllLessonPlanEditHistoryAPIView, EditHistoryReviewAPIView,
...
urlpatterns = [
    ...
    path('lesson-plans/<int:pk>/download/', LessonPlanDownloadAPIView.as_view(), name='lesson-plan-download'),
    ...
    path('lesson-plans/edit-histories/all/', AllLessonPlanEditHistoryAPIView.as_view(), name='all-lesson-plan-histories'),
    path('lesson-plans/edit-histories/<int:pk>/review/', EditHistoryReviewAPIView.as_view(), name='edit-history-review'),
