...
*   **Các thành phần giao diện đột phá mới:**
    ...
    *   **Custom Interactive Knowledge Graph Canvas & BFS Hops**: Bộ vẽ đồ thị 2D Force-Directed trên thẻ Canvas hiệu năng cao. Hỗ trợ cuộn phóng to/thu nhỏ (Zoom & Pan), kéo thả các nút, bôi sáng đường dẫn các nút tương ứng với RAG retrieval. Tích hợp **bộ lọc khoảng cách liên kết (Hop Distance 1, 2, 3 hops)** truyền động đến backend để tối ưu hiển thị qua thuật toán duyệt BFS.
